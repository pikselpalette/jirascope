...
async function run (appName) {
  const defaultConfig = {
    ...
    allowedRootIssueLabels: ['strategic', 'requirement', 'initiative', 'milestone']
    // allowedRootIssueTypes: ['Strategic', 'Requirement', 'Initiative', 'Milestone']
  }
  ...
  const jirascope = new Jirascope(jiraClient, dataStore, {
    ...
    allowedRootIssueLabels: config.allowedRootIssueLabels
  })
