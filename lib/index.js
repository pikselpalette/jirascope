 ...
 * @param {string[]} options.allowedRootIssueLabels - An array of labels that are allowed to mark valid root issues
 *
      ...
      if (stack.length !== 0) {
        ...
        while (stack.length !== 0) {
          ...
          if (issue) {
            ...
            if (issue.analysis.root && _.intersection(this.options.allowedRootIssueLabels, issue.labels).length === 0) {
